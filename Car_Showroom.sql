...
serialnumber varchar(255),
primary key (Customer_id, employee_id, serialnumber),
foreign key (Customer_id) references customers(Customer_id),
foreign key (employee_id) references employee(employee_id),
foreign key (serialnumber) references car(serialnumber)
);
...
-- Customers --
insert into customers (Customer_id, First_name, Second_name, Birth_Date, Adress, ZIP_code, City)
values
...
-- Custmers Phone --
insert into Cutomers_phone (Customer_id, Phone_number)
values
('C001', '01012345678'),
('C002', '01123456789'),
('C003', '01234567890'),
...
-- Car Order --
insert into carorder (Customer_id, employee_id, orderdate, downpayment, serialnumber)
values
...
SELECT Customer_id 
FROM customers
WHERE Customer_id IN ('C001', 'C002', 'C003', 'C004', 'C005', 'C006', 'C007', 'C008', 'C009', 'C010', 
...
-- 6. Count how many cars are available by brand
